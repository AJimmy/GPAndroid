package com.alice.loadersmscontactstest.apdater;
...
public class SmsSimpleCursorAdapter extends SimpleCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (holder == null) {
            ...
            holder.txtPhone = (TextView) view.findViewById(R.id.item_sms_phone);
            holder.txtTime = (TextView) view.findViewById(R.id.item_sms_time);
            view.setTag(holder);
        }
        ...
        holder.txtPhone.setText(name);

        String dataStr = cursor.getString(cursor.getColumnIndex("date"));
