 ...
 * Original file: D:\\IDEAWork\\HangUp\\src\\com\\android\\internal\\telephony\\ITelephony.aidl
 */
...
case TRANSACTION_answerRingCall:
{
...
@Override public void answerRingCall() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_answerRingCall, _data, _reply, 0);
...
static final int TRANSACTION_answerRingCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_endCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void answerRingCall() throws android.os.RemoteException;
